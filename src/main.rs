...
mod lib;
use lib::{tgv_denoise, parallel_tgv_denoise};
...
// fn tgv_denoise(u0: &ArrayView2<f32>, lam: f32, alpha0: f32, alpha1: f32, tau: f32, sigma: f32, n_iter: i32) -> Array2<f32> {
...
fn main() {
    ...
    let denoised_img = parallel_tgv_denoise(&grayscale_img.view(), 10.0, 2.0, 1.0, 0.125, 0.125, 300);
